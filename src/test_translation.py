...
class TestTextToHtml(unittest.TestCase):
    ...
    def test_bold_tag(self):
        ...
        self.assertEqual(
            "<b>This is a bold node</b>", text_node_to_html_node(node).to_html()
        )

    def test_italic_tag(self):
        node = TextNode("This is an italic node", "italic")
        self.assertEqual(
            "<i>This is an italic node</i>", text_node_to_html_node(node).to_html()
        )

    def test_code_tag(self):
        aa = TextNode("This is a code node", "code")
        self.assertEqual(
            "<code>This is a code node</code>", text_node_to_html_node(aa).to_html()
        )
