...
class TestHTMLNode(unittest.TestCase):
    ...
    def test_three_positional(self):
        ...
        self.assertEqual(
            'HTMLNode(tag="p", value="This is text", children=[HTMLNode()])', str(node2)
        )
    ...
    def test_all_positional(self):
        ...
        self.assertEqual(
            "HTMLNode(tag=\"p\", value=\"This is text\", children=[HTMLNode()], props={'url': 'http://boot.dev'})",
            str(node2),
        )
    ...
    def test_no_children(self):
        ...
        self.assertEqual(
            "HTMLNode(tag=\"p\", value=\"This is text\", props={'url': 'http://boot.dev'})",
            str(node),
        )
